...
//    for(fullName of presidents){
//        console.log(fullName.first, fullName.last)
//    }

// for(let i = 0; i < presidents.length; i++){
//     console.log(i);
//     console.log(presidents[i].first, presidents[i].last);
// }

//Silver: Only console.log IF the president is alive
// for(let i = 0; i < presidents.length; i++){
//     if(presidents[i].passed === undefined){
//         console.log(presidents[i].first, presidents[i].last)
//     }
// }
...
//Gold: Convert the if statement to a ternary
// for(let i = 0; i < presidents.length; i++){
    //     presidents[i].passed === undefined ? console.log(presidents[i].first, presidents[i].last) : null 
    //             // conditional                ?           if-is-true-do-this                         :  if-is-false-to-this
    // }
    // for(let i = 0; i < presidents.length; i++){
    //     !presidents[i].passed ? console.log(presidents[i].first, presidents[i].last) : null 
    //             // conditional                ?           if-is-true-do-this                         :  if-is-false-to-this
    // }
    // for(let i = 0; i < presidents.length; i++){
    //     presidents[i].passed  ?? console.log(presidents[i].first, presidents[i].last)
    //             // conditional                ?           if-is-true-do-this                         :  if-is-false-to-this
    // }
...
console.log(marcoStudents[2].grades[0].Grade);

//Loop through Array using ForEach and console.log name and subject
marcoStudents.forEach((student) => console.log(student.name, student.subject))