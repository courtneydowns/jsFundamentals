...
//example 2:
function sentence(firstName, lastName){ //can have multiple inputs (in this case, first name and last name) 
 return `My first name is ${firstName} and my last name is ${lastName}`;
}

console.log(sentence('Jonathan', 'Huer'));
console.log(sentence('Courtney', 'Downs'));
let superImportantSentence = sentence('Suzanne', 'Crouch');
...
function iteratorFunc(inputArr){ //when a function doesn't return anything, it's called a side-effect which means there is some alternative action to a simple return.
